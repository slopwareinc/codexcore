...
- a **Manual Browser**: an embedded WKWebView for user-directed navigation (not agent browser-tool integration);
...
Open **Manual Browser** for user-directed documentation and local previews. It is an embedded WKWebView; the user navigates it, and it is not an agent-controlled browser tool.

![Manual Browser showing Swift documentation](../assets/screenshots/browser-panel.png)
