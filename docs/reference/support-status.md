...
| Attachments, mentions, slash commands, queued follow-ups, steer, interrupt | Supported | Follow-ups queue during an active turn and expose explicit steer, edit, and remove actions above the composer. |
