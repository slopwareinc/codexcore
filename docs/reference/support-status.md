...
| Automations | Supported | Local TOML-backed schedules run as independent chats while the app is open; native completion notifications require macOS permission. No first-class app-server automation API exists in the pinned protocol. |
