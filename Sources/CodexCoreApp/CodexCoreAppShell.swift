...
struct CodexCoreAppShell: View {
    ...
    private func chatWorkspace(proxy: GeometryProxy) -> some View {
        ...
        return CodexChatWorkspaceView(
                ...
                attachedSkills: model.attachedSkills,
                skillPlacements: model.composerSkillPlacements,
                onMentionQueryChanged: { model.updateMentionQuery($0) },
                onMentionSelected: { model.selectMention($0) },
                onSkillTagSelected: { model.attachComposerSkill($0, atUTF16Offset: $1) },
                onSkillTagRemoved: { model.removeComposerSkill(id: $0) },
                onSkillPlacementsChanged: { model.updateComposerSkillPlacements($0) },
