...
enum CodexThemedAppIcon {
    ...
    static func render(
        ...
        let markSide = canvasSize.width * internalScale
        let markRect = NSRect(
        ...
        return NSImage(size: canvasSize, flipped: false) { bounds in
            let background = NSBezierPath(
                ...
                xRadius: bounds.width * 0.215,
                yRadius: bounds.height * 0.215
            )
            ...
            shadow.shadowBlurRadius = bounds.width * 0.038
            ...
            background.lineWidth = bounds.width * 0.005
            background.stroke()
            return true
        }
    }
