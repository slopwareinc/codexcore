...
final class AppServerGeneratedUnionTests: XCTestCase {
    ...
    func testThreadItemDecodesEveryCurrentDiscriminator() throws {
        let samples: [(String, String)] = [
            ...
            ("mcpToolCall", #"{"type":"mcpToolCall","id":"i8","arguments":{},"readOnlyHint":true,"server":"s","status":"inProgress","tool":"t"}"#),
            ...
            ("imageGeneration", #"{"type":"imageGeneration","id":"i15","result":"ok","status":"completed","transparentBackground":true}"#),
    ...
    func testGA145ResumeCursorsAreTyped() throws {
        let json = #"""
        {
